	...
	<p style="color: red">*Please enter data in every field to Add Student to the system.</p><br><br>
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    ...
				    Full name:<input type="text" class="form-control" name="name" placeholder="Enter Full name" required>
				  </div>
				  <div class="form-group">
				      Father name <input type="text" class="form-control" name="fname" placeholder="Enter Father_name:" required>
				  </div>
				  <div class="form-group">
