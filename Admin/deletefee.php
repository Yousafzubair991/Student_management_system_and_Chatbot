...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="deletefee.php" class="active"><i class="fa fa-edit"></i></i>Delete Fee Status</a>
...
<div class="container99">
		...
		<div class="col-md-6 col-md-offset-3  jumbotron ">
			<br><br><h2 class="text-center">Delete Student's Fee Information</h2><br><br>
			...
			while ($DataRows = mysqli_fetch_assoc($result)) {
               ...
               $Id = $DataRows['id'];
				...
				<tr>
					...
					<td><a href="delrecord.php?Delete=<?php echo $Id; ?>&Picture=<?php echo $ProfilePic;?>" class="btn btn-danger">Delete</a></td>
				</tr>
				<?php
