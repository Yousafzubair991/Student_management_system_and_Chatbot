<?php
  ...
  if(isset($_POST['submit'])!=""){
   ...
   $move =  move_uploaded_file($temp,"../coordinator/result/".$fname);
   if($move){
...
<a href="uploadresult.php"  class="active"><i class="fas fa-eye"></i> VIEW RESULT</a>
    ...
    <div class="col-md-6 col-md-offset-3  jumbotron ">
     ...
     <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
      ...
      <tr>
        ...
        <td>
          <button class="button"><a href="download1.php?filename=<?php echo $name;?>&f=<?php echo $row['fname'] ?>">Download</a></button>
        </td>
      </tr>
      <?php }?>
    </table>
