...
<a href="addfee.php"  class="active"><i class="fa fa-plus-square"></i> ADD FEE</a>
<br><br><br>
    ...
    <div class="col-md-6 col-md-offset-3  jumbotron ">
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    ...
				    Fee_Amount:<input type="text" class="form-control" name="fee_amount" placeholder="Enter Fee Amount" required>
				  </div>
				  <div class="form-group">
				    
				    Semester:<input type="text" class="form-control" name="semester" placeholder="Enter Semester" required>
				  </div>
				  <div class="form-group">
	...
	if (isset($_POST['submit'])) {
		if (!empty($_POST['roll']) && !empty($_POST['fullname'])) {
			...
			if ($run == true) {
				...
				?>
				<script>
					alert("Challan already exists. Enter again");
				</script>
				<?php 
			}
		} else {
