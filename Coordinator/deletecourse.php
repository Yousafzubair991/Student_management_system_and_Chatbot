...
<a href="deletecourse.php" class="active"><i class="fa fa-minus-square"></i>REMOVE COURSE</a>
...
<div class="container99">
		...
		<div class="col-md-6 col-md-offset-3  jumbotron ">
			<br><br><h2 class="text-center">Delete Course</h2><br><br>
...
<table class="table table-striped table-bordered table-responsive center">
	...
	<tr>
		...
		<th class="text-center">courseCredit</th>
		...
		if (mysqli_num_rows($result)>0) {
			...
			$semester=$DataRows['semester'];
				...
				<tr>
					...
					<td><a href="delrec.php?Delete=<?php echo $Id; ?>" class="btn btn-danger">Delete</a></td>
				</tr>
				<?php
