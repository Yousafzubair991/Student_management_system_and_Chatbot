...
<br><br><br>
<a href="deletestudent.php" class="active"><i class="fa fa-minus-square"></i>DELETE STUDENT DETAIL</a>
...
<div class="container99">
		...
		<div class="col-md-6 col-md-offset-3  jumbotron ">
			<br><br><h2 class="text-center">Delete Student's Information</h2><br><br>
